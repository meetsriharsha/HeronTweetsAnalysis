...
public class PrinterBolt extends BaseBasicBolt {
    ...
    File source = new File("/media/harsha/64B41DEAB41DBF8A/Stuff/UMKC/RTBDA/Hackathon/Heron-TwitterDataAnalysis-v3/heron-starter/lib/HighCharts/examples/dynamic-update/Source.txt");
    String word = " ";
